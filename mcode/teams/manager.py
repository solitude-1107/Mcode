...
from mcode.teams.backend_detect import BackendDetectionError, detect_backend
from mcode.teams.mailbox import Mailbox, create_message
...
from mcode.teams.progress import TeammateProgress
from mcode.teams.registry import AgentNameRegistry
from mcode.teams.shared_task import SharedTaskStore
from mcode.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from mcode.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
