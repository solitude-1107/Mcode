...
from mcode.teams.progress import TeammateProgress, random_verb

if TYPE_CHECKING:
    from mcode.agent import Agent
    from mcode.conversation import ConversationManager
    from mcode.teams.models import TeammateInfo
    ...
    async def _run() -> str:
        ...
        try:
            if conversation is not None:
                ...
                from mcode.conversation import ConversationManager as CM
                conv = CM()
