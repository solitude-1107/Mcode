...
from mcode.agent import PermissionResponse


_PERM_OPTIONS = [
    ("是", PermissionResponse.ALLOW),
    ("是，且不再询问此模式", PermissionResponse.ALLOW_ALWAYS),
    ("否", PermissionResponse.DENY),
]
