...
from mcode.skills.parser import SkillDef, substitute_arguments

if TYPE_CHECKING:
    from mcode.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from mcode.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
