...
if TYPE_CHECKING:
    ...
    from mcode.client import LLMClient
...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from mcode.agents.fork import ForkError, build_forked_messages
        from mcode.agents.parser import AgentDef
        from mcode.agents.tool_filter import clone_registry_for_fork, resolve_agent_tools
        from mcode.agent import Agent as AgentClass
        ...
        if p.subagent_type is None:
            from mcode.context import clone_replacement_state
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from mcode.agents.fork import ForkError, build_forked_messages
        from mcode.agents.parser import AgentDef
        from mcode.agents.tool_filter import build_teammate_tools
        from mcode.agent import Agent as AgentClass
        from mcode.conversation import ConversationManager
        from mcode.permissions import (
            DangerousCommandDetector,
        ...
        from mcode.teams.models import BackendType, TeammateInfo
    ...
    def _spawn_pane_teammate(
        ...
        try:
            if backend == BackendType.TMUX:
                from mcode.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from mcode.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from mcode.worktree.integration import (
    ...
    def _create_client_for_model(self, model_alias: str) -> LLMClient | None:
        ...
        from mcode.client import create_client
        from mcode.config import ProviderConfig
