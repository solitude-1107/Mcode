...
def build_teammate_tools(
    ...
    from mcode.tools.send_message import SendMessageTool
    from mcode.tools.task_create import TaskCreateTool
    from mcode.tools.task_get import TaskGetTool
    from mcode.tools.task_list import TaskListTool
    from mcode.tools.task_update import TaskUpdateTool
...
def clone_registry_for_fork(parent_registry: ToolRegistry) -> ToolRegistry:
    ...
    from mcode.tools.agent_tool import FORK_QUERY_SOURCE
