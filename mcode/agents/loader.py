...
PROJECT_AGENTS_DIR = ".mcode/agents"
USER_AGENTS_DIR = "~/.mcode/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("mcode.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from mcode.agents.parser import parse_frontmatter, _validate_agent_meta
