...
IDENTITY_SECTION = PromptSection(
    ...
    priority=0,
    content=(
        "You are MCode, an AI programming assistant running in the terminal. "
...
def build_system_prompt(
    ...
    if coordinator_mode:
        from mcode.teams.coordinator import get_coordinator_system_prompt
