...
from mcode.conversation import (
    ConversationManager,
    Message,
    ToolResultBlock,
    estimate_tokens,
)
from mcode.serialization import build_messages
...
SESSION_SUBDIR = ".mcode/session/tool-results"
...
async def auto_compact(
    ...
    for attempt in range(max_retries):
        try:
            from mcode.tools.base import StreamEnd, StreamEvent, TextDelta
